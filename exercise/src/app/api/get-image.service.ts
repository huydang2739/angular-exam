...
export class GetImageService {
  ...
  getAnimalImage(params: { page: number, limit: number, search: string }) {
    return this.httpClient.get<Image>(`${this.baseUrl}/animals`, { params: this.createParams(params) })
  }

  getFoodImage(params: { page: number, limit: number, search: string }) {
    return this.httpClient.get<Image>(`${this.baseUrl}/foods`, { params: this.createParams(params) })
  }
